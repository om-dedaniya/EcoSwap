        ...
        <table className="min-w-full table-auto border">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="text-left px-6 py-3 text-sm font-semibold text-gray-700">Rating</th>
              <th className="text-left px-6 py-3 text-sm font-semibold text-gray-700">Review</th>
            ...
            {currentReviews.map((review, idx) => {
              ...
              return (
                <tr key={idx} className="border-t">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700">{review.email}</td>
                  <td className="px-6 py-4 text-yellow-500 text-lg">{review.rating} ⭐</td>
