...
import { faHeadset, faCircleQuestion, faBook } from "@fortawesome/free-solid-svg-icons";
...
const NeedHelp = () => {
  ...
  const helpOptions = [
    ...
    },
    {
      ...
      link: "mailto:ecoswap@gmail.com",
    },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-100 py-16 px-6 md:px-12 lg:px-24">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {helpOptions.map((help, index) => (
          ...
          >
            <FontAwesomeIcon icon={help.icon} className="text-green-500 text-4xl mb-4" />
            <h5 className="text-xl font-semibold text-gray-800">{help.title}</h5>
